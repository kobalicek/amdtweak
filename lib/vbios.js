...
vbios.$define({
  $name: "SClockDependencyTable",
  $extend: vbios.CommonArrayHeader
});

// ATOM_Tonga_SCLK_Dependency_Table
vbios.$define({
  $extend: vbios.SClockDependencyTable,
  $version: [0],
  $members: [
    { $name: "Entries"                        , $type: Arr, $ref: vbios.SClockDependencyEntry$0, $length: "NumEntries" }
  ]
});
...
vbios.$define({
  ...
  $version: [1],
  $members: [
    { $name: "Entries"                        , $type: Arr, $ref: vbios.SClockDependencyEntry$1, $length: "NumEntries" }
  ]
});

// ATOM_Vega10_CLK_Dependency_Record
// VEGA: WW: this is NOT considered as a new version of SClockDependencyEntry from Tonga/Polaris
//           this one is used by severals VEGA10 dependency tables
vbios.$define({
  $name: "ClockDependencyEntry",
  $version: [0],
  $members: [
    { $name: "Clock"                           , $type: U32 },
...
// VEGA: WW: VEGA bios PP_Table has a SOCCLK_Dependency_Table with ID '0'
//     that isn't a new version of SCLK_Dependency_Table
//     this may comflict with ATOM_Tonga_SCLK_Dependency_Table
vbios.$define({
  $extend: vbios.SocClockDependencyTable,
  $version: [0], 
  $members: [
    { $name: "Entries"                        , $type: Arr, $ref: vbios.ClockDependencyEntry$0, $length: "NumEntries" }
  ]
});
...
vbios.$define({
  ...
  $version: [1],
  $members: [
    { $name: "MemClock"                       , $type: U32 }, /* Clock Frequency */
    { $name: "VddIndex"                       , $type: U8  }, /* SOC_VDD index */
    { $name: "VddMemIndex"                    , $type: U8  }, /* MEM_VDD - only non zero for MCLK record */
    { $name: "VddciIndex"                     , $type: U8  }  /* VDDCI   = only non zero for MCLK record */
  ]
});
...
vbios.$define({
  ...
  $version: [0],
  $members: [
    { $name: "Clock"                          , $type: U32 }, /* Clock Frequency */
    { $name: "VddIndex"                       , $type: U8  }, /* SOC_VDD index */
    { $name: "CKSVOffsetAndDisable"           , $type: U16 }, /* Bits 0~30: Voltage offset for CKS, Bit 31: Disable/enable for the GFXCLK level. */
    { $name: "AVFSOffset"                     , $type: U16 } /* AVFS Voltage offset */
  ]
});
...
vbios.$define({
  $name: "GfxClockDependencyEntry",
  $version: [1], // WW: version is named 'GFXCLK_Dependency_Record_V2' but ID is probably '1'
  $members: [
    { $name: "Clock"                          , $type: U32 }, /* Clock Frequency */
    { $name: "VddIndex"                       , $type: U8  }, /* SOC_VDD index */
    { $name: "CKSVOffsetAndDisable"           , $type: U16 }, /* Bits 0~30: Voltage offset for CKS, Bit 31: Disable/enable for the GFXCLK level. */
...
vbios.$define({
  ...
  $version: [1], // WW: version is named 'GFXCLK_Dependency_Record_V2' but ID is probably '1'
  $members: [
    { $name: "Entries"                        , $type: Arr, $ref: vbios.GfxClockDependencyEntry$1, $length: "NumEntries" }
  ]
});
...
// VEGA VoltageLookupTable
// ATOM_Vega10_Voltage_Lookup_Table
vbios.$define({
  $extend: vbios.VoltageLookupTable,
  $version: [1],
  $members: [
    { $name: "Entries"                        , $type: Arr, $ref: vbios.VoltageLookupEntry$1, $length: "NumEntries" }
  ]
});

// 'Non-VEGA' MMDependencyEntry
vbios.$define({
...
vbios.$define({
  ...
  $version: [1],
  $members: [
    { $name: "VddcInd"                        , $type: U8  }, /* SOC_VDD voltage index */
    { $name: "DCLK"                           , $type: U32 }, /* UVD D-clock */
    { $name: "VCLK"                           , $type: U32 }, /* UVD V-clock */
    { $name: "ECLK"                           , $type: U32 }, /* VCE clock */
    { $name: "PSPClk"                         , $type: U32 }  /* PSP clock */
  ]
});
...
vbios.$define({
  ...
  $version: [1],
  $members: [
    { $name: "Entries"                        , $type: Arr, $ref: vbios.MMDependencyEntry$1, $length: "NumEntries" }
  ]
});
...
vbios.$define({
  ...
  $members: [
    ...
    { $name: "SocClockIndex"                  , $type: U8  }, // Index into 'SClockDependencyTable'/'SocClockDependencyTable'.
...
vbios.$define({
  ...
  $version: [2],
  $members: [
    { $name: "LCLK"                           , $type: U32 }, /* L Clock */
    { $name: "PCIEGenSpeed"                   , $type: U8  }, /* PCIE Gen */
    { $name: "PCIELaneWidth"                  , $type: U8  }  /* PCIE Lane Width */	
  ]
});
...
vbios.$define({
  ...
  $version: [2],
  $members: [
    { $name: "Entries"                        , $type: Arr, $ref: vbios.PCIEEntry$2, $length: "NumEntries" }
  ]
});
...
vbios.$define({
  ...
  $members: [
    ...
    { $name: "PlatformCaps"                   , $type: U32 },
    { $name: "GfxClockMaxOD"                  , $type: U32 }, // GPU Core Max Clock
    { $name: "MemClockMaxOD"                  , $type: U32 }, // HBM2 Max Clock
    ...
    { $name: "SocClockDependencyTable"        , $type: U16 , $ref: vbios.SClockDependencyTable  },
...
vbios.$define({
  ...
  $members: [
    ...
    { $name: "FormatId"                       , $type: U16 },
    { $name: "PlatformCaps"                   , $type: U32 },
    { $name: "SocClockMaxOD"                  , $type: U32 }, // In 10kHz unit.
    { $name: "MemClockMaxOD"                  , $type: U32 }, // In 10kHz unit.
    { $name: "PowerControlLimit"              , $type: U16 }, // In %, default range -50% +50%, max 142%
    { $name: "UlvVoltageOffset"               , $type: U16 }, // In [mV] unit.
    ...
    { $name: "SocClockDependencyTable"        , $type: U16 , $ref: vbios.SocClockDependencyTable  }, // Soc/controler clock
    { $name: "MemClockDependencyTable"        , $type: U16 , $ref: vbios.MemClockDependencyTable  }, // VRam clock
    { $name: "GfxClockDependencyTable"        , $type: U16 , $ref: vbios.GfxClockDependencyTable  }, // Main GPU clock
