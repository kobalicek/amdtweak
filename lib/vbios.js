...
//     end of `vbios.js`. To make it more natural to follow the data structures
...
function extractPowerPlayFromVBIOS(buf, offset) {
  ...
  const ppHeader = header.RomTable.MasterDataTable.PowerPlayTable;
  const ppStart  = ppHeader.$meta.absOffset;
  const ppEnd    = ppStart + ppHeader.StructureSize;
