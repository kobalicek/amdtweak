...
atom.$addStruct({
  ...
  $members: [
    ...
    { $name: "strMemPNString"                 , $type: Str, $length: 10 }
  ]
});
...
atom.$addStruct({
  ...
  $members: [
    ...
    { $name: "VRAMModules"                    , $type: Arr, $ref: atom.VRAMModule, $length: "NumVRAMModules", $version: "VRAMModuleVer" }
  ]
});
...
atom.$addStruct({
  ...
  $members: [
    ...
    { $name: "Reserved1"                      , $type: atom.WriteOneByteHWI2CDataParameters }
  ]
});
